"""Initializing db with roles and user_roles table to handle role permissions

Revision ID: 02a116b9cb2b
Revises: 
Create Date: 2020-01-12 22:47:02.029133
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('username', sa.String(length=64, collation='NOCASE'), nullable=True),
    sa.Column('email', sa.String(length=128, collation='NOCASE'), nullable=True),
